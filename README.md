...
am-deny-hosts periodically updates your /etc/hosts.deny file using downloaded block lists that contain IP addresses of SSH attackers. You hosts.deny file can up updated periodically by adding a cron job to run the script 
